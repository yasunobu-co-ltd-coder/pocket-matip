...
-- ■ pocket-matip テーブル
DROP POLICY IF EXISTS "Allow all on pocket-matip" ON "pocket-matip";
DROP POLICY IF EXISTS "anon_select_only" ON "pocket-matip";
CREATE POLICY "anon_select_only" ON "pocket-matip"
